...
$bidding_start_time = strtotime($product['bidding_date'] . ' ' . $product['bidding_time']);
$bidding_end_time = date("Y-m-d H:i:s", $bidding_start_time + 1800);
?>
...
<div class="container">
    ...
    <img src="<?php echo htmlspecialchars($product['image_path']); ?>" alt="Product Image" width="100%" style="border-radius: 10px; margin-bottom: 15px;">
    ...
    <div class="product-details">
        ...
        <h3>Bidding Ends At: <?php echo htmlspecialchars($bidding_end_time); ?></h3>
    </div>

    <button type="button" class="btn" onclick="window.location.href='buy.php';">Back</button>
    
    <!-- Button to trigger popup -->
    <button class="btn" onclick="checkBiddingStatus()">I'm Interested</button>

    <!-- Countdown Timer -->
    <div id="countdown"></div>

    <!-- Popup Modal for Bid Confirmation -->
...
<script>
    ...
    let auctionEndTime = new Date("<?php echo htmlspecialchars($bidding_end_time); ?>").getTime();
    ...
    let countdown = setInterval(function() {
        ...
        if (timeLeft > 0) {
            ...
            document.getElementById("countdown").innerHTML = `Bidding ends in: ${hours}h ${minutes}m ${seconds}s`;
        } else {
